...
<div class="container">
			...
			<h1 class="text-center mt-5">Reporte de Ingresos<img src="imagenes/repor.png" class="img-thumbnail" width="100" height="70"class="d-inline-block align-text-top"></h1>
			<br>
