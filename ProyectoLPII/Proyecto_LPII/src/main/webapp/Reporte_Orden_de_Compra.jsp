...
<div class="container">
			...
			<h1 class="text-center mt-5">Reporte de Orden de Compra<img src="imagenes/repor.png" class="img-thumbnail" width="100" height="70"class="d-inline-block align-text-top"></h1>
			<br>
	<div class="mt-4">
			<table id="example" class="table table-striped" style="width:100%">
		        <thead>
		            <tr class="table-success">
		                <th>Num. Orden_Compra</th>
		                <th>Fecha Orden_Compra</th>
		                <th>Fecha_Entrega</th>
		                <th>Cod Proveedor</th>
