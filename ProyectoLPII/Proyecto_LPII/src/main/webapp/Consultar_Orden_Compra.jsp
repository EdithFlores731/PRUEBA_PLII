...
<body>
	...
	<div class="container">
			<h1 class="text-center mt-5">Consultar Orden de compra<img src="imagenes/repor.png" class="img-thumbnail" width="120" height="70"class="d-inline-block align-text-top"></h1>
			<br>	
			<div class="form-outline mb-4">
			  <h4>  Ingrese Código <input type="search"> <button type="button" class="btn btn-success">Buscar</button></h4>
			</div>
			<br>
			<div >
			 <table  class="table table-striped" style="width:100%">
		        <thead>
		            <tr class="table-success">
		                <th>Num_Orden_Compra</th>
		                <th>Fecha_Orden_Compra</th>
		                <th>Fecha_Entrega</th>
		                <th>Cod_Proveedor</th>
		                <th>Condición_Pago</th>
		                <th>Embalaje</th>
		                <th>Transporte</th>
		                <th>Valor_Total O.C.</th>
		            </tr>
		        </thead>
	 			 <tbody>
		             <tr>
